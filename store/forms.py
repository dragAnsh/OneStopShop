...
class UserInfoForm(forms.ModelForm):
	...
	email = forms.CharField(label="", widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'Email Address'}), required = False)
	...
	class Meta:
		model = Profile
		fields = ('phone', 'full_name', 'email', 'address1', 'address2', 'city', 'state', 'zipcode', 'country', )
...
class UpdateUserForm(UserChangeForm): # UserChangeForm Doesn't allow you to change your password.
